defmodule Goscope.Export.Entries do
  ...
  def build(%{type: "Update"}, _cat) do
    [
      [1, 2, "Programming Language", "", "Update Ruby from X.X.X to X.X.X", ""],
      [3, 2, "Web Framework", "", "Update Rails from X.X to X.X", ""],
      [0.5, 1, "Dependencies", "", "Upgrade ruby gems to latest versions", ""],
      [1.5, 2, "Dependencies", "", "Resolve dependency conflicts", ""],
      [
        3,
        1,
        "Automated Tests",
      ...
      [4, 1, "Automated Tests", "", "Add additional automated tests", ""],
      [1, 1, "Automated Tests", "", "Add continuous integration", ""]
    ]
  end
end
